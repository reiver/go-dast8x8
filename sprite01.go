...
var sprite01 [rgba32sprite8x8.ByteSize/rgba32.ByteSize][rgba32.ByteSize]uint8 = [rgba32sprite8x8.ByteSize/rgba32.ByteSize][rgba32.ByteSize]uint8{
//	0	1	2	3	4	5	6	7
	...
	red,	red,	black,	black,	black,	red,	red,	yellow,
	red,	nada,	red,	red,	red,	nada,	nada,	nada,
